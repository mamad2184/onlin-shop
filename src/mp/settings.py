...
ALLOWED_HOSTS = ["172.25.87.239", "localhost", "127.0.0.1","onlin-shop-production.up.railway.app", "onlin-shop-production-0b1f.up.railway.app"]
...
if DEBUG:
    ...
    STORAGES = {
        "default": {
            "BACKEND": "mp.storage.SupabasePublicStorage",
        },
        "staticfiles": {
            "BACKEND": "django.contrib.staticfiles.storage.StaticFilesStorage",
        },
